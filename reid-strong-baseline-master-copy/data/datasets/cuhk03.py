...
class CUHK03(BaseImageDataset):
    ...
    def __init__(self, root='/home/daa/Desktop/reid-strong-baseline-master/data', split_id=0, cuhk03_labeled=False,
        ...
        self.split_classic_det_json_path = osp.join(self.dataset_dir, 'splits_classic_detected_v2.json')
        self.split_classic_lab_json_path = osp.join(self.dataset_dir, 'splits_classic_labeled.json')

        self.split_new_det_json_path = osp.join(self.dataset_dir, 'splits_new_detected_v2.json')
