...
class DukeMTMCreID(BaseImageDataset):
    ...
    def __init__(self, root='/home/haoluo/data', verbose=True, **kwargs):
        ...
        self.train_dir = osp.join(self.dataset_dir, 'DukeMTMC-reID/bounding_box_train_anonymised')
        self.query_dir = osp.join(self.dataset_dir, 'DukeMTMC-reID/query_anonymised')
        self.gallery_dir = osp.join(self.dataset_dir, 'DukeMTMC-reID/bounding_box_test_anonymised')
